...
class App extends Component {
  ...
  onClickVisitButton = country => {
    this.setState(prevState => {
      const updateList = initialCountriesList.map(each => {
    ...
    this.setState(prevState => {
      ...
      const countryIndex = initialCountriesList.findIndex(
      ...
      for (let i = 0; i < countryList.length; i++) {
        const listIndex = initialCountriesList.findIndex(
